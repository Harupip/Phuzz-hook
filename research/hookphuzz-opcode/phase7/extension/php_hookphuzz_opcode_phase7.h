#ifndef PHP_HOOKPHUZZ_OPCODE_PHASE7_H
#define PHP_HOOKPHUZZ_OPCODE_PHASE7_H

extern zend_module_entry hookphuzz_opcode_phase7_module_entry;
#define phpext_hookphuzz_opcode_phase7_ptr &hookphuzz_opcode_phase7_module_entry

#define PHP_HOOKPHUZZ_OPCODE_PHASE7_VERSION "0.7.0"
#define HOOKPHUZZ_OPCODE_PHASE7_MAX_EVENTS 4096
#define HOOKPHUZZ_OPCODE_PHASE5_MAX_EVENTS HOOKPHUZZ_OPCODE_PHASE7_MAX_EVENTS
...
ZEND_BEGIN_MODULE_GLOBALS(hookphuzz_opcode_phase7)
...
ZEND_END_MODULE_GLOBALS(hookphuzz_opcode_phase7)

ZEND_EXTERN_MODULE_GLOBALS(hookphuzz_opcode_phase7)
#define HOOKPHUZZ_PHASE7_G(v) ZEND_MODULE_GLOBALS_ACCESSOR(hookphuzz_opcode_phase7, v)
#define HOOKPHUZZ_PHASE5_G(v) HOOKPHUZZ_PHASE7_G(v)
