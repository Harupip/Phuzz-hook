...
if __package__ in (None, ""):
    ...
    from .generated_config_runner import format_validation_result, load_generated_configs, run_generated_configs, write_report
    from .pipeline import run_entrypoint_pipeline
