...
class ZendDiscoveryTests(unittest.TestCase):
    ...
    def test_rest_get_param_fixture_is_packaged_with_search_only_callback(self) -> None:
        ...
        self.assertNotIn("params['POST']['email']", source)
        self.assertNotIn("params['JSON']['name']", source)
        self.assertNotIn("params['URL']['id']", source)
        self.assertNotIn("get_param('mode')", source)
        ...
        self.assertIn("register_rest_route('hookphuzz/v1', '/query-params'", source)
        self.assertIn("register_rest_route('hookphuzz/v1', '/nested-param'", source)
        self.assertNotIn("register_rest_route('hookphuzz/v1', '/form'", source)
        self.assertNotIn("register_rest_route('hookphuzz/v1', '/json'", source)
        self.assertNotIn("register_rest_route('hookphuzz/v1', '/item/(?P<id>\\\\d+)'", source)
        with zipfile.ZipFile(plugin_zip) as archive:
